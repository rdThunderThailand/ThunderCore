...
import { ScenarioBroadcastCard } from './scenario/components/ScenarioBroadcastCard'
...
export function ApplicationManagementidClient({ appId }: { appId: string }) {
    ...
    return (
        <div className="mx-auto max-w-7xl space-y-6 p-8">
            <AppManagementHeader
                app={{ id: app.id, tenant_id: app.tenant_id, name: app.name, status: app.status, url: app.url }}
