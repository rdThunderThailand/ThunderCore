        ...
        <>
                                    ...
                                    <button
                                        ...
                                        className={`
                                            ...
                                            ${isActive
                                                ...
                                                : `border-slate-200 bg-white hover:border-slate-300 hover:shadow-sm cursor-pointer ${isSaving || isLoading ? 'opacity-50 cursor-not-allowed' : ''
                                                }`
                                            }
                                        `}
                                    >
            ...
            {toast && (
                <div className="fixed bottom-8 right-8 z-50 animate-in fade-in slide-in-from-bottom-5">
                    <div className={`px-4 py-3 rounded-xl shadow-lg border flex items-center gap-3 ${toast.type === 'success'
